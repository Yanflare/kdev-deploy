...
Safe zones only: ~/.kdev/skills/, LINUX_BOOT_PROMPT.md, agent-memory/*.md
...
SAFE_ZONE_FILES = [
    os.path.join(DEPLOY_DIR, "LINUX_BOOT_PROMPT.md"),
...
def run_planning(safe_zone_content: str, past_log: str) -> str:
    ...
    - LINUX_BOOT_PROMPT.md (improve the system prompt)
