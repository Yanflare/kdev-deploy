#!/usr/bin/env python3
"""
KDEV TERMINAL UI v1.7 — Cyberpunk KDE Operator Console
"""
...
KDEV_VERSION = "Phase 2A — Corpus 106+"   # internal only
...
class KDEVApp(App):
    ...
    BINDINGS = [("?", "noop", None)]   # completely kills the ? overlay
    ...
    def on_button_pressed(self, event):
        """Click header → maximize that panel"""
        panel_map = {
    ...
    # (rest of the methods unchanged — update_corpus, update_status, load_recent_traces,
    # live_log_stream, live_corpus_watcher, kairos_heartbeat, on_input_submitted)
