#!/usr/bin/env python3
"""
KDEV TERMINAL UI v1.6 — Cyberpunk KDE Operator Console
"""
...
class KDEVApp(App):
    ...
    Button:hover { color: #ff0033; text-style: bold; }
    """
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container():
            ...
            # BOTTOM: Command Chat Log
            with Vertical(classes="panel", id="command_panel"):
    ...
    def on_button_pressed(self, event):
        """Clicking any panel header maximizes that panel"""
        panel_id = event.button.id.replace("_header", "_panel")
        panel = self.query_one(f"#{panel_id}")
        panel.focus()
        self.action_maximize()   # Textual built-in maximize
